...
public class JSGD extends javax.swing.JFrame {
        ...
        {            
            ...
            else
            {
                ...
                if (iError == SGFDxErrorCode.SGFDX_ERROR_NONE)
                {
                    ...
                    //PersonaControl.insertar2(regMin1, " Frank Farrufia ");
                    ...
                    try {
                       ...
                       // String nombre    = registroHuella.get("nombre").toString();
                        ...
                        iError = fplib.MatchTemplate(regMin1,validHuella, secuLevel, matched); 
                        
                        if (iError == SGFDxErrorCode.SGFDX_ERROR_NONE)
                        {
                                matchScore[0] = 0;
                                iError = fplib.GetMatchingScore(regMin1, validHuella, matchScore);

                                if (iError == SGFDxErrorCode.SGFDX_ERROR_NONE)
                                {
                                    if (matched[0]){
                                        //this.jLabelStatus.setText( "Registration Success, Matching Score: " + matchScore[0]);
                                        System.out.println("Las huellas coinciden Nombre: "+nombre);
                                    }
    ...
    private void jButtonInitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInitActionPerformed
     ...
     private void openDevice() {//GEN-FIRST:event_jButtonInitActionPerformed
        /*int selectedDevice = jComboBoxDeviceName.getSelectedIndex();
        switch(selectedDevice)
        {
            case 0: //USB
